    ...
    <section className="hero" id="hero">
      ...
      <div className="container hero-content">
        ...
        <div className="hero-subtitle" ref={subtitleRef} style={{ transform: 'translateY(20px)' }}>
          <span className="hero-subtitle-role">Staff Software Engineer</span>
          <span className="hero-subtitle-sep" />
          <span className="hero-subtitle-company">Palo Alto Networks</span>
        </div>

        <p className="hero-tagline" ref={taglineRef} style={{ transform: 'translateY(20px)' }}>
          I keep Prisma Cloud running. When it doesn't, I'm the one who fixes it.
        </p>
        ...
        >
          ...
          <a
            ...
            href="/resume/Aditi_Joshi_Resume.pdf"
            target="_blank"
